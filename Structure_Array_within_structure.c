...
int main()
{
    ...
    for(int i=0; i<4; i++)
    {
        ...
        fgets(person[i].name,20,stdin);            Ekhane shudhu abar scanf diye korle oi shomossha hobe na kintu tokhon ekta naam er er por ar space dewa jabe na. Ar evabe korle space dewa jabe    
